...
<script type="text/javascript" src="<c:url value="/resources/app/js/empenho.js"/>"></script>
	...
	<div id="wrapper">
		<div id="header-wrapper">
			...
			<script type="text/javascript">
 				var especie = '<c:out value="${especie}"/>';
 				var empenhoId='<c:out value="${empenhoId}"/>';
			</script>
		</div>
		<!-- end #header -->
		...
		<div id="page">
			<div class="center">
				<div id="dadosBasicoPanel"></div>
				</br>
				<div id="dadosDetalhadosPanel"></div>
				</br>
				<div id="liquidacoesGrid"></div>
			</div>
		</div>
		<!-- end #page -->
	</div>
