...
<script type="text/javascript" src="<c:url value="/resources/app/js/transferenciasFinanceiras.js"/>"></script>
...
<body>
	...
	<div id="page">
		<div class="center">
			<div id="consultaTransferenciaFinanceiraForm"></div>
			</br>
			<div id="TransferenciaFinanceiraGrid"></div>
